<template>
  <footer class="w-full bg-base-200 py-12 md:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto">
        ...
        <div class="flex space-x-10 justify-center items-center mb-10">
          <a href="javascript:;" class="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
        ...
        <span class="text-lg text-gray-500 text-center block"><a href="https://pagedone.io/">FurnTune</a> 2024, Alle Rechte vorbehalten.</span>
      </div>
    </div>
  </footer>
</template>
